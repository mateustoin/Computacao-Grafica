...
float vertices[] = {-0.25f, -0.5f, -0.1f, 0.75f, 0.75f, 0.75f, // white triangle (closer)
                     0.25f,  0.5f, -0.1f, 0.75f, 0.75f, 0.75f,
                     0.75f, -0.5f, -0.1f, 0.75f, 0.75f, 0.75f,

                    -0.75f, -0.5f, -2.8f, 0.0f, 0.75f, 0.0f, // green triangle (farther)
                    -0.25f,  0.5f, -2.8f, 0.0f, 0.75f, 0.0f,
                     0.25f, -0.5f, -2.8f, 0.0f, 0.75f, 0.0f}; 
...
void Display(void) {
    ...
    */
    ...
    // Contém as informações de Posição da câmera
    //                          Up da câmera
    //                          Posição para onde aponta
...
int main(int argc, char** argv) {
    ...
    // Título da janela
    glutCreateWindow("Mateus Antonio - Exercicio 5 (Transformacoes Livres)");
